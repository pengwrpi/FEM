...
void Reorder(const pMesh& mesh, const std::string& ele_type) {
  ...
  pNumbering numbers = pumi_numbering_create(mesh, "my_numbers", NULL); //create an empty numbering for reordering
